...
source_folder = args.pred_path+'/'
ground_folder = args.gt_path+'/'
theta = float(args.theta)  # overlap ratio
number_label = 51 #specific for TSU_v1
...
if __name__ == '__main__':
    ...
    for method in methods:
        v_props,v_grounds = process(method)
